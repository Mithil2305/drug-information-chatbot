...
export function LoadingState() {
  return (
    <div className="flex items-start gap-3 animate-fade-in">
      ...
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-primary text-white shadow-subtle mt-0.5">
        <Bot className="h-[18px] w-[18px]" />
      </div>

      <div className="rounded-2xl rounded-tl-sm border border-border bg-surface p-5 shadow-card">
